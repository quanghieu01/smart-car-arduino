...
static esp_err_t fanon_handler(httpd_req_t *req){
    ledcWrite(ledChannel, 127); 
    Serial.println("fan ON");
    httpd_resp_set_type(req, "text/html");
    return httpd_resp_send(req, "OK", 2);
}
static esp_err_t fanoff_handler(httpd_req_t *req){
...
void startCameraServer(){
    ...
    httpd_uri_t ledoff_uri = {
     ...
     httpd_uri_t fanon_uri = {
        .uri       = "/fanon",
        .method    = HTTP_GET,
        .handler   = fanon_handler,
        .user_ctx  = NULL
    };
    
    httpd_uri_t fanoff_uri = {
        .uri       = "/fanoff",
        .method    = HTTP_GET,
        .handler   = fanoff_handler,
        .user_ctx  = NULL
    };
   ...
   httpd_uri_t stream_uri = {
    ...
    if (httpd_start(&camera_httpd, &config) == ESP_OK) {
        ...
        httpd_register_uri_handler(camera_httpd, &fanon_uri);
        httpd_register_uri_handler(camera_httpd, &fanoff_uri);
    }
